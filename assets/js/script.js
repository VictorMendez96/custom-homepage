      ...
      .then(function (object) {
        for (let i = 0; i < 25; i++) {
          ...
          thumbnail.setAttribute(
            "src",
            object.data.children[i].data.thumbnail
          );
          ...
          if (
            object.data.children[i].data.thumbnail === "self" ||
            object.data.children[i].data.thumbnail === "default"
          ) {
            thumbnail.setAttribute(
              "src",
              "assets/img/reddit_logo_horizontal_on_orangered.png"
            );
          } else if (object.data.children[i].data.thumbnail === "nsfw") {
            thumbnail.setAttribute(
              "src",
              "assets/img/interstitial-image-over18.png"
            );
          ...
          // ================================
          var subreddit =
            object.data.children[i].data.subreddit_name_prefixed;
